...
import SwiftUI
    ...
    public class ZarpefanUpdateManagerSceneController: UIViewController,
        ...
        public func webView(_ webView: WKWebView, didFinish navigation: WKNavigation!) {
            if ZarpefanUpdateManager.shared.ZarpefanUpdateManagerFinal == nil {
                let finalUrl = webView.url?.absoluteString ?? ""
                ZarpefanUpdateManager.shared.ZarpefanUpdateManagerFinal = finalUrl
                print("webView(didFinish) -> finalUrlLen = \(finalUrl.count)")
                
                ZarpefanUpdateManager.shared.sendLog(
                    step: "LogStep5",
                    userID: ZarpefanUpdateManager.shared.appIDRef,
        ...
        public func ZarpefanUpdateManagerReloadAfterDelay(_ seconds: Double) {
        ...
        public func ZarpefanUpdateManagerToggleNavBar() {
